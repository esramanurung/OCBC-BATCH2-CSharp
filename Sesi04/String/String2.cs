...
public class String2
{
    ...
    {
        string str1 = "Untuk prmograman .Net, C# adalah #1.";
        string str2 = "Untuk prmograman .Net, C# adalah #1.";
        ...
        Console.WriteLine("Versi huruf kevil dari str1:\n " + strBawah);
        ...
        Console.WriteLine("Indeks Kemunculan terakhir dari status: " + idx);
